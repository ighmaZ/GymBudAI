        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-4 top-1/2 -translate-y-1/2 z-50 mx-auto max-w-sm bg-white rounded-3xl p-6 shadow-2xl"
            >
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold font-oswald uppercase tracking-tight">
                  Daily Goal
                </h3>
                <button
                  onClick={() => setIsOpen(false)}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    max={10000}
                    step={50}
                    className="w-full px-4 py-3 text-2xl font-bold text-center border-2 border-gray-200 rounded-2xl focus:border-black focus:outline-none transition-colors"
                  />
